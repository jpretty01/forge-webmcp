# FORGE — 121-Second Caption-Led Submission Video

## Recording Format

- Record at 1920×1080, 30 fps, with the browser at 100% zoom.
- Use a supported Chromium WebMCP preview on the public FORGE URL.
- Use burned-in narrative captions with no voice.
- Use the locally generated original instrumental bed; do not use copyrighted music.
...
- Keep every caption synchronized with the screen that supports it, then upload publicly to YouTube.

## Shot Plan and Caption Narrative

### 0:00–0:06 — Define FORGE

**On screen:** FORGE title card over a subdued view of the landing page.

**Caption narrative:**

“A WebMCP control plane for finding, approving, testing, and reversing game-world changes.”

**On-screen title:** `FORGE · Human-agent world laboratory`

### 0:06–0:18 — The problem

**On screen:** The critical progression-deadlock result and logical reproduction.

**Caption narrative:**

“In Ashen Reach, the key needed to open the sanctum is spawned inside that locked sanctum. This circular dependency makes the main rescue quest impossible to complete.”

**On-screen title:** `The problem · A quest that cannot be completed`

### 0:18–0:30 — A world both sides understand
...
### 0:30–0:42 — Native WebMCP foundation
...
### 0:42–0:54 — A real defect, not a scripted answer
...
### 0:54–1:08 — Human-governed repair
...
### 1:21–1:41 — Provenance and rollback
...
- Normalize the music bed to remain gentle and unobtrusive.
